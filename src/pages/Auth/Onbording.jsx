            ...
            <div className="w-lg-500px p-10 p-lg-15 mx-auto">
                <form className="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-dark mb-3">Onbording SilkRoute </h1>
                        <div className="text-gray-400 fw-bold fs-4">Please enter your domain name you want to host your
                            website on</div>
                    </div>
                    <div className="fv-row mb-10 fv-plugins-icon-container">
                        <label className="form-label fs-6 fw-bolder text-dark">Store Username</label>
                        <input className="form-control form-control-lg form-control-solid" type="text" name="website" />
                        <div className="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <p className='text-center'>Or</p>
                    <div className="fv-row mb-10 fv-plugins-icon-container">
                        <label className="form-label fs-6 fw-bolder text-dark">Website domain</label>
                        <input className="form-control form-control-lg form-control-solid" type="text" name="website" />
                        <div className="fv-plugins-message-container invalid-feedback"></div>
                    </div>
